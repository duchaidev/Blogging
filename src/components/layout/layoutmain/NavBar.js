        ...
        <div className="add-post">
          ...
          >
            <button className="">
              ...
              >
                <path
                  d="M12.8571 30V17.1429H0V12.8571H12.8571V0H17.1429V12.8571H30V17.1429H17.1429V30H12.8571Z"
                  fill="white"
                />
              </svg>
            </button>
          ...
          {sidebarLink.map((item) => {
            return (
              <NavLink to={item.url} className="menu-item" key={item.title}>
                ...
                <span className="mt-[2px] text-xs font-normal text-white whitespace-nowrap">
                  {item.title}
                </span>
              </NavLink>
            );
