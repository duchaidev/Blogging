...
import ListHeader from "../../components/dropdown/List";
...
const PostItem = ({
  ...
  return (
    <StylePostItem className="bg-[#fff] dark:bg-transparent dark:border-[#686c72]">
      <div className="flex items-center justify-between mb-[15px] ">
        <div className="flex items-center gap-2">
          ...
          <NavLink to={toInfo}>
            <h2 className="text-black dark:text-gray-300">{nameAuthor}</h2>
          </NavLink>
        </div>
        <div>
          <Dropdown>
            <Select threedot classname="!p-2"></Select>
            <ListHeader threedot>
      ...
      <div className="item">
        <div className="flex flex-col gap-2">
          <NavLink
            to={to}
            className="text-black dark:text-gray-100 font-semibold text-[18px]"
          >
            {title}
          </NavLink>
          <NavLink to={to}>
            <p
              className="dark:text-[#8e8e8e] text-gray-700 text-[15px]"
              title={content}
            >
              {content}
            </p>
